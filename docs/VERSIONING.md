...
Patch and metadata-only updates may change the Python package version without changing the C ABI version. ABI-breaking changes must increment `DBS_ABI_VERSION`, update `docs/ABI.md`, and regenerate `docs/abi/v*.symbols`.
