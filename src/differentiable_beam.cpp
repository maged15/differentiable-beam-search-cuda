...
#if DBS_CAN_COMPILE_AVX512
    if (runtime_has_avx512()) return avx512::dot(a, b, n);
#endif
#if DBS_CAN_COMPILE_AVX2
    if (runtime_has_avx2()) return avx2::dot(a, b, n);
#endif
#if DBS_CAN_COMPILE_SSE42
    if (runtime_has_sse42()) return sse42::dot(a, b, n);
#endif
#if DBS_ARM_NEON
    if (runtime_has_neon()) return neon::dot(a, b, n);
#endif
...
#if DBS_CAN_COMPILE_AVX512
    if (runtime_has_avx512()) return avx512::sum_sigmoid_shifted(scores, n, theta, temperature);
#endif
